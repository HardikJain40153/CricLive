...
const MyCard = ({ match }) => {
  ...
  const getMatchCard = () => (
    <div>
      <Card
        style={{
          background: match.matchStarted ? "#ffffff" : "",
          marginTop: 15,
        }}
      >
        <CardContent>
          <Grid container justify="center" alignItems="center" spacing={2}>
            <Grid item>
              <Typography variant="h5" style={{fontWeight: "bold"}}>{match["team-1"]}</Typography>
            </Grid>
            <Grid item>
              <img
                style={{ width: 85 }}
            ...
            <Grid item>
              <Typography variant="h5" style={{fontWeight: "bold"}}>{match["team-2"]}</Typography>
            </Grid>
          </Grid>
        </CardContent>
